...
from bdbox import Choice, Inches, Int, Model, Preset
...
class ScrewHandle(Model):
    length: float = Inches(6)
    height: float = Inches(1 + 1 / 4)
    ...
    screw_hole_depth: float = Inches(0)
            ...
            with (
                ...
                Locations(
                    (
                        0,
                        0,
                        self.screw_hole_depth or self.height / 2,
                    )
                ),
            ):
